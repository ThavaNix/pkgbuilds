...
#include <memory>
#include "../../../../../src/libcalamaresui/modulesystem/RequirementsChecker.h"
...
QT_MOC_LITERAL(3, 53, 18), // "requirementsResult"
QT_MOC_LITERAL(4, 72, 16), // "RequirementsList"
QT_MOC_LITERAL(5, 89, 20), // "requirementsComplete"
QT_MOC_LITERAL(6, 110, 4), // "done"
QT_MOC_LITERAL(7, 115, 3), // "run"
QT_MOC_LITERAL(8, 119, 22), // "addCheckedRequirements"
QT_MOC_LITERAL(9, 142, 8), // "finished"
QT_MOC_LITERAL(10, 151, 14) // "reportProgress"

    },
    "Calamares::RequirementsChecker\0"
    "requirementsProgress\0\0requirementsResult\0"
    "RequirementsList\0requirementsComplete\0"
    "done\0run\0addCheckedRequirements\0"
    "finished\0reportProgress"
};
...
void Calamares::RequirementsChecker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->requirementsResult((*reinterpret_cast< RequirementsList(*)>(_a[1]))); break;
        case 2: _t->requirementsComplete((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 3: _t->done(); break;
        case 4: _t->run(); break;
        case 5: _t->addCheckedRequirements((*reinterpret_cast< RequirementsList(*)>(_a[1]))); break;
        case 6: _t->finished(); break;
        case 7: _t->reportProgress(); break;
        default: ;
        }
        ...
        {
            using _t = void (RequirementsChecker::*)(RequirementsList );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RequirementsChecker::requirementsResult)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RequirementsChecker::requirementsComplete)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 1
void Calamares::RequirementsChecker::requirementsResult(RequirementsList _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
...
// SIGNAL 2
void Calamares::RequirementsChecker::requirementsComplete(bool _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
