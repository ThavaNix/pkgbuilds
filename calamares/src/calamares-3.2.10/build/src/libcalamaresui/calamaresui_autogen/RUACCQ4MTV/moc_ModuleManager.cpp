...
QT_MOC_LITERAL(6, 84, 18), // "requirementsResult"
QT_MOC_LITERAL(7, 103, 16), // "RequirementsList"
QT_MOC_LITERAL(8, 120, 20), // "requirementsProgress"
QT_MOC_LITERAL(9, 141, 6) // "doInit"

    },
    "Calamares::ModuleManager\0initDone\0\0"
    "modulesLoaded\0modulesFailed\0"
    "requirementsComplete\0requirementsResult\0"
    "RequirementsList\0requirementsProgress\0"
    "doInit"
};
...
void Calamares::ModuleManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->requirementsResult((*reinterpret_cast< RequirementsList(*)>(_a[1]))); break;
        case 5: _t->requirementsProgress((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 6: _t->doInit(); break;
        default: ;
        }
        ...
        {
            using _t = void (ModuleManager::*)(RequirementsList );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ModuleManager::requirementsResult)) {
                *result = 4;
                return;
            }
        }
...
// SIGNAL 4
void Calamares::ModuleManager::requirementsResult(RequirementsList _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
