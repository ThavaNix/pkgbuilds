...
public:
    ...
    void setupUi(QWidget *Page_UserSetup)
    {
        ...
        username_extra_label_2->setText(QString::fromUtf8("<Username extra label 2 text>"));
        ...
        hostname_extra_label_2->setStyleSheet(QString::fromUtf8("font-weight: normal"));
        ...
        password_extra_label_3->setStyleSheet(QString::fromUtf8("font-weight: normal"));
        ...
        labelExtraRootPassword->setStyleSheet(QString::fromUtf8("font-weight: normal"));
    ...
    void retranslateUi(QWidget *Page_UserSetup)
    {
        ...
        hostname_extra_label_2->setText(QCoreApplication::translate("Page_UserSetup", "<small>This name will be used if you make the computer visible to others on a network.</small>", nullptr));
        ...
        password_extra_label_3->setText(QCoreApplication::translate("Page_UserSetup", "<small>Enter the same password twice, so that it can be checked for typing errors. A good password will contain a mixture of letters, numbers and punctuation, should be at least eight characters long, and should be changed at regular intervals.</small>", nullptr));
        ...
        labelExtraRootPassword->setText(QCoreApplication::translate("Page_UserSetup", "<small>Enter the same password twice, so that it can be checked for typing errors.</small>", nullptr));
    } // retranslateUi
